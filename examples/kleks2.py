...
MATRIX = (
  ...
  (  _TAB, HT(_LSH, _Z), _S, _D, _F, _G, _H, _J, _K, _L, HT(_RSH, _SL), _DEL),
  (0, _RAL, _X, _C, _V, _B, _N, _M, _CM, _DT, _AU, 0),
  (0, _LCT, _LSP, _LAL, HT(_L1, _ESC), _BS, HT(_RAL, _SPC), HT(_L2, _ENT), _AL, _AD, _AR, 0)
), (
  (_F1, _1, _F2, _F3, _F4, _F5, _F6, _F7, _F8, _F9, _0, _F10),
  (_CAPS, _BSL, _2, _3, _4, _5, _6, _7, _8, _9, _SC, _INS),
  (0, _RAL, _LB, _RB, _MN, _EQ, _MN, _EQ, _LB, _RB, _PGUP, 0),
  (0, _LCT, _LSP, _LAL, _L1, _L2, _SPC, _L3, _HOME, _PGDN, _END, 0)
), (
  (_GR, _LSH|_1, _LSH|_GR, _APP, _LAL|_F4, _PS, _VD, _VU, _MT, _LAL|_F11, _LSH|_0, _LAL|_F12),
  (_LAL|_TAB, _LSH|_BSL, _LSH|_2, _LSH|_3, _LSH|_4, _LSH|_5, _LSH|_6, _LSH|_7, _LSH|_8, _LSH|_9, _LSH|_SC, _LAL|_DEL),
  (0, _RAL, _LSH|_LB, _LSH|_RB, _LSH|_MN, _LSH|_EQ, _AL, _AD, _AU, _AR, _PGUP, 0),
  (0, _LCT, _LSP, _LAL, _L3, _BS, _L1, _L2, _HOME, _PGDN, _END, 0)
), (
